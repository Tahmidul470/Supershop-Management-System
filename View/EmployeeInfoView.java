...
public class EmployeeInfoView extends JFrame {
    ...
    public void initialize(EmployeeInfoModel eim,Connection connection){
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\Office-Customer-Male-Light-icon.png"));
        ...
        label.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\Admin-icon.png"));
        ...
        label_1.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\dark-blue-pattern-wallpapers-desktop-background.jpg"));
