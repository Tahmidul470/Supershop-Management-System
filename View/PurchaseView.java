...
public class PurchaseView extends JFrame {
    ...
    public void initialize(PurchaseModel pcm, Connection connection){
        ...
        lblPurchasStation.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\santa_s_bag.png"));
        ...
        btnNewButton.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\shop-icon.png"));
        ...
        try {
            ...
            label = new JLabel("");
            label.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\1.jpg"));
