...
public class ProductListView extends JFrame {
    ...
    public void initialize(ProductListModel plm, Connection connection){
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\shopping_bag.png"));
        ...
        btnLoadProducts.setSelectedIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\package_installed_updated.png"));
        btnLoadProducts.setBackground(SystemColor.menu);
        btnLoadProducts.setFont(new Font("Trebuchet MS", Font.BOLD, 14));
        btnLoadProducts.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\santa_s_bag.png"));
        ...
        label_1 = new JLabel("");
        label_1.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\plus.png"));
        ...
        label_3 = new JLabel("");
        label_3.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\bt_remove.png"));
        label_3.setBounds(226, 362, 48, 46);
        contentPane.add(label_3);
        contentPane.add(btnDeleteProduct);

        label_2 = new JLabel("");
        label_2.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\system_software_update.png"));
        label_2.setBounds(127, 362, 48, 46);
        contentPane.add(label_2);
        contentPane.add(btnUpdate);

        JLabel label = new JLabel("");
        label.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\shopping_bag.png"));
        ...
        label_4 = new JLabel("");
        label_4.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\find.png"));
        ...
        label_5 = new JLabel("");
        label_5.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\default.jpg"));
