...
public class AdminPageView extends JFrame {
    ...
    public void initialize(AdminPageModel apm, Connection connection) {
        setIconImage(Toolkit.getDefaultToolkit().getImage("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\anyone.png"));
        ...
        btnNewButton_1.setIcon(new
                ...
                ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\deletered.png"));
        ...
        try {
            ...
            label_1 = new JLabel("");
            label_1.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\man_brown.png"));
            ...
            label_2 = new JLabel("");
            label_2.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\find.png"));
            label_2.setBounds(522, 11, 67, 42);
            contentPane.add(label_2);

            label = new JLabel("");
            label.setVerticalAlignment(SwingConstants.BOTTOM);
            label.setIcon(new ImageIcon("D:\\Code(Updated)-20220330T155627Z-001\\Code(Updated)\\Icons\\green-wallpaper-17318-17874-hd-wallpapers.jpg"));
